...
We recommend using the 'survey'(@JSSv009i08) package from CRAN (@Hornik2012TheCR) to perform these analyses and we provide some examples of how to do that in our companion software package 'phonto' (cite phonto).
