...
## row bind dataframes with different columns
demo_i = nhanes("DEMO_J")
dim(demo_i)
demo = dplyr::bind_rows(demo_i,demo_j)

## merge DEMO_J and BXP_J with SEQN.  
bpx_j = nhanes("BPX_J")
data = merge(demo_j,bpx_j, by="SEQN")

head(data[,c("SEQN","RIAGENDR","RIDRETH1","BPXDI1","BPXSY1")])
