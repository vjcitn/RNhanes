...
We next describe a number of the computational and analytic challenges that need to be addressed, highlighting how the `nhanesA` package offers effective and reproducible solutions. For a full list and description of `nhanesA` functions refer to <INCLUDE LINK>.
