...
We recommend using the 'survey' package from CRAN (cite this) to perform these analyses and we provide some examples of how to do that in our companion software package 'phonto' (cite phonto).

## Data
 
The 'nhanesA' package was developed to enable fully customizable retrieval of data NHANES. 
