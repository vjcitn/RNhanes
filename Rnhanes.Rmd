...
\begin{figure}
  ...
  \caption{a) shows the raw data the both geneder and enthinicity are encoder as intergers. b) shows the translated data with nhanesA.}
  \label{fig:DEMO_J}
\end{figure}
